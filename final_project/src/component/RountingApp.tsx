      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <nav className="bg-blue-500 p-4">
          <ul className="flex space-x-4">
            ...
            <li>
              <Link to="/books/list" className="text-white hover:underline">
                List/Edit/Delete Book
              </Link>
            </li>
            <li>
              <Link to="/books/new" className="text-white hover:underline">
                Add New Book
              </Link>
            </li>
          </ul>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Routes>
            ...
            {/*<Route path="/dorms/new" element={<LoginForm />} />*/}
          </Routes>
        </div>
      </div>
    </BrowserRouter>
